...
{
	public ControlButtons controls;
	...
	public void paint(Graphics graphics)
	{
		...
		else 
		{
			...
			{
				controls.st_but.setText("Restart");
				controls.st_replay.setEnabled(true);
				controls.st_pse.setEnabled(false);
				controls.st_undo.setEnabled(false);
